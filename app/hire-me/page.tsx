...
import BookingSuccess from "@/components/BookingSuccess"; // ← add
import { LINKS } from "@/config/links";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Hire Me | Jutellane Solutions",
  description: "Ready to engage? Book a time to discuss deliverables, timelines, and pricing for your DevSecOps or cloud project.",
...
export default function HireMePage() {
  return (
    <main className="mx-auto max-w-4xl px-4 sm:px-6 py-12">
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/40 p-3">
