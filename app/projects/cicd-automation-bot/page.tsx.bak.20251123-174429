  ...
  return (
    <main className="page-shell">
      ...
      <SectionFadeIn as="header" delay={0.06} className="space-y-5">
        ...
        <h1 className="page-title">CI/CD Automation Bot</h1>

        <p className="page-subtitle max-w-3xl">
          A pipeline-aware bot that posts rich deployment notifications into
          Microsoft Teams — so every release is visible, auditable, and easy to
          follow without digging through raw logs.
        </p>

        {/* Simple gradient “hero card” instead of a screenshot for now */}
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-sky-700 px-6 py-8 text-slate-50 shadow-lg dark:border-slate-800/70 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-sky-800">
          ...
          <p className="mt-3 max-w-2xl text-sm text-slate-100">
            When a release finishes, the bot posts a single, readable card into
            Teams with the app, environment, status, commit SHA, actor, and
            links to dashboards. No more “who just deployed what?” in chat.
          </p>
        </div>
      </SectionFadeIn>
      ...
      <SectionFadeIn as="section" delay={0.22} className="mt-10 space-y-3">
        ...
        <p className="section-body">
          ...
          <span className="italic"> “customer-portal deployed to production”</span>,
