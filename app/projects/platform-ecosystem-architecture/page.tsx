  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      <section className="relative border-b border-slate-200 bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col gap-6 px-4 pb-16 pt-20 sm:px-6 lg:px-8">
          <motion.div
            initial="hidden"
            animate="visible"
            variants={fadeUp}
            className="inline-flex items-center gap-2 rounded-full border border-sky-500/40 bg-sky-500/10 px-3 py-1 text-xs font-medium uppercase tracking-wide text-sky-700 dark:text-sky-200"
          >
          ...
          <motion.h1
            variants={fadeUp}
            className="mt-5 max-w-3xl text-balance text-3xl font-semibold tracking-tight text-slate-900 dark:text-slate-50 sm:text-4xl lg:text-5xl"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="mt-5 max-w-3xl text-base text-slate-700 dark:text-slate-50 sm:text-lg"
          >
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                {section.bullets.map((item) => (
                  <li key={item} className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-sky-600 dark:bg-sky-400" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
...
     +--------------------------------------------------------------+`}
        ...
        >
          <div className="flex items-center gap-2">
            <Timer className="h-5 w-5 text-sky-600 dark:text-sky-300" />
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-50">
              Delivery Timeline
            </h2>
          </div>
        ...
        <motion.section
          ...
          viewport={{ once: true, amount: 0.15 }}
          variants={fadeUp}
          className="mb-12 rounded-2xl border border-emerald-500/40 bg-gradient-to-br from-emerald-50/40 via-white to-slate-50 p-6 dark:from-emerald-500/10 dark:via-slate-900 dark:to-slate-900"
        >
          <h2 className="flex items-center gap-2 text-2xl font-semibold text-emerald-700 dark:text-emerald-100">
          ...
          <ul className="mt-4 space-y-2 text-sm text-emerald-900/90 dark:text-emerald-50/90">
            {outcomes.map((item) => (
...
export default PlatformEcosystemArchitecturePage;