  ...
  return (
    <section className="bg-white px-6 py-24 text-center text-slate-900 dark:bg-slate-950 dark:text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-5 leading-8 text-slate-600 dark:text-slate-400 md:text-lg">
          Whether you need architecture guidance, DevSecOps implementation, or
          platform engineering support, JLT-Lane can help you design and build
          with confidence.
        </p>
        ...
        <p className="mt-5 text-sm text-slate-500 dark:text-slate-500">
          Explore services, book directly, or start with a conversation.
        </p>
      </div>
    </section>
  );
