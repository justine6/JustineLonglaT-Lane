...
export default function HeroBanner() {
  ...
  const imageOpacity = useTransform(scrollYProgress, [0, 0.8, 1], [1, 1, 0.92]);
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-h-[88vh] max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-20">
        <div className="relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-8 max-w-xl rounded-[1.75rem] border border-slate-200/80 bg-white/85 p-6 shadow-[0_16px_55px_rgba(15,23,42,0.10)] backdrop-blur dark:border-white/10 dark:bg-slate-900/70 dark:shadow-[0_18px_55px_rgba(2,8,23,0.45)]"
            >
        ...
        <div className="relative">
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/80 shadow-[0_20px_70px_rgba(15,23,42,0.12)] backdrop-blur dark:border-white/10 dark:bg-slate-900/70 dark:shadow-[0_20px_70px_rgba(2,8,23,0.55)]">
