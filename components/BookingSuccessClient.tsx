...
export default function BookingSuccessClient() {
  ...
  const variant = (sp.get("v") ?? "").toLowerCase();     // "", compact, marketing
      ...
      <section className={cardClasses}>
        ...
        {(start && end) && (
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            {gcal && <a className="btn-secondary" href={gcal} target="_blank" rel="noopener noreferrer">Add to Google</a>}
            {o365 && <a className="btn-secondary" href={o365} target="_blank" rel="noopener noreferrer">Add to Outlook</a>}
            <a className="btn-secondary" href="/booking/success.ics" download> Add to Apple (.ics) </a>
          </div>
        )}
